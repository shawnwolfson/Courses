...
int Company::getRelativeValue() const
{
    return relative_value;
}

void Company::setID(const int id) 
{
    this->id=id;
}

void Company::raiseRelativeValue(const double raise)
{
    relative_value += raise;
}

void Company::setRelativeValue(const double value)
{
