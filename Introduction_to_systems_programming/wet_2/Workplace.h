...
/**
 * setCompareFunctionManager: A function object that tells the Set how to compare Managers
 *
...
public:
 ...
 /**
 * emptyEmployeeGroup: A function that deletes all the Employees from a Manager's Employees set.
 *
 ...
 */ 
 ...
 /**
 * changeSalaryForAllEmployeesUnderManager: If a Manager has Employees, update the salary of his Employees, 
...
/**
 * getManagersId: A function that gets all the id's of the Managers that work in this Workplace. Returns a vector.
 * @return  
