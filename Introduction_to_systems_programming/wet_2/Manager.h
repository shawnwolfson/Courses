...
/**
 * setCompareFunctionEmployee: A function object that tells the Set how to compare Employees
 *
 * @param employee1 - Employee pointer for first Citizens
 * @param employee2 - Employee pointer for second Citizen
 * @return
 *      true - if employee1's id is less than employee1's id;
 *      false - if employee1's id is greater than employee2's id; 
 */
...
/**
 * getEmployeesId: A function that gets all the id's of the Employees that work under this manager. Returns a vector.
 * @return
...
/**
 * hasEmployees: A function that checks whether or not this Manager has Employees.
 * @return
